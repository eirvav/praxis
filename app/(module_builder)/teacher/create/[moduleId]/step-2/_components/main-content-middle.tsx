...
import { VideoUploadSlide } from './slide-types/video-upload-slide'
import { TextResponseSlide } from './slide-types/text-response-slide'
...
export function MainContentMiddle() {
	...
	return (
		<Card className='flex h-full w-full flex-col overflow-hidden self-start'>
			...
			<Separator />
			<CardContent className='flex-1 min-h-0 overflow-y-auto bg-muted/10 p-4 pt-0'>
